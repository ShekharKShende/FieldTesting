...
// Used for to pass the drawer to the all children
    ...
    render(){
      console.log("RouterConfig");
        ...
        if(this.props.checkedAuthentication && (!isAuthenticated || this.props.checkedRole)){
            ...
            return (
              <Router createReducer={reducerCreate}>
                ...
                <Scene key="root" hideNavBar={true}>
                  <Scene key='Login' component={requireMaskComponent(LoginView)} initial={initialLogin} hideNavBar={true} type='reset'/>
                  <Scene key='AddComment' component={requireMaskComponent(AddComment)} hideNavBar={true} title='ADD COMMENT' type='push'/>
                  <Scene key='MyTestDetailView' component={requireMaskComponent(MyTestDetailView)} type="push" hideNavBar={true}/>
                    <Scene key='SampleDetails' component={requireMaskComponent(SampleDetailsView)} type="push" hideNavBar={true}/>
                  <Scene key='Drawer' hideNavBar={false} component={SideDrawer} initial={initialDrawer}>
