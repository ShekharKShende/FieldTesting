...
class MyTestDetailView extends BaseComponent {
          ...
          if(feed.image && feed.isSync && feed.isSync == true) {
            ...
            returnFeedbackView.push(
                <View style={{flex:0,flexDirection:'column'}} key = {feed.id+''}>
                    ...
                    <Image source={require('image!speech_bubble')}
         ...
         <View style = {styles.container}>
                   <ScrollView>
                        <View style= {styles.scrollViewcontainer}>
                          {this.props.trialSelected.sample.images[0].imageUrl != null?
                            <CacheImage
                              resizeMode='contain'
                              url={this.props.trialSelected.sample.images[0].imageUrl}
