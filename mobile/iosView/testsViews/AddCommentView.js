...
class AddCommentView extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
       if(nextProps.commentCreatedRequestStarted) {
         if (!nextProps.commentCreated && nextProps.commentCreationErrorMessage) {
           AlertIOS.alert(nextProps.commentCreationErrorMessage);
         }else if(nextProps.commentCreated){
            this.onDismiss()
         } else if(nextProps.commentUploadImageFailed) {
           AlertIOS.alert(null, nextProps.commentUploadImageFailed, this.onDismiss);
        }
     }
   }
  ...
  onCreatecommentRequest() {
    ...
    if(this.state.comment.trim() == '') {
       AlertIOS.alert('Please enter Comment');
       return;
    }
