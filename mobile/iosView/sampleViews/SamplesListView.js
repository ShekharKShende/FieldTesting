...
renderRow(sampleRow) {
  ...
  <TouchableHighlight key = {sampleRow.id+''} onPress={() => this.rowPressed(sampleRow)}>
    <View style={styles.listcontainer} key = {sampleRow.id+''}>
         {sampleRow.image != null ?
           <CacheImage
             resizeMode='contain'
             url={sampleRow.image}
             style={[AppStyles.listThumbnailStyle, {marginLeft:12}]}
           ...
           />
            :
        <View  style={[AppStyles.listThumbnailStyle, {marginLeft:12,backgroundColor:'#b7bbbc'}]}></View>}
    ...
    return (
      <View style={styles.container}>
        ...
        {this.props.isNetworkStatus?
          ...
          <Text style={{alignSelf:'center', marginTop:100,  fontSize: 16,
            color : '#B7BABB',
            fontFamily: 'Helvetica Neue',
