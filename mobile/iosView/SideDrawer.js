import React, { Text, View, Component, PropTypes, StyleSheet, ListView, TouchableOpacity,AlertIOS, Image } from 'react-native';
		...
		return (
			<View style = {styles.container}>
				{config.USER_PROFILE != null ?
					...
					<Image style={styles.roundImage} source={require('common/images/icon_profile_large@2x.png')} />
...
class SideDrawer extends Component {
	...
	onDrawerOpen() {
		this.props.drawerAction.updateToggelDrawerOpenState(true);
	}

	onDrawerClose() {
		this.props.drawerAction.updateToggelDrawerOpenState(false);
	}
