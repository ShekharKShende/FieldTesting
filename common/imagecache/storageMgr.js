...
class StorageMgr {
    constructor() {
        ...
        db.transaction((tx)=>{
            tx.executeSql('CREATE TABLE IF NOT EXISTS '+TABLE_CACHE_IMAGE+' (url varchar(40) primary key, ref integer, size integer, time integer, mdate integer)');
            tx.executeSql('CREATE TABLE IF NOT EXISTS '+TABLE_CACHE_ID+' (id varchar(40) primary key, url varchar(40), mdate integer)');
